...
class LibroController {
    ...
    def buscarLibros() {
        if(!params.autor) {
          flash.message="Debe ingresar un Autor para buscar Libros"
          return redirect(action: 'index')
        }
        flash.message="Resultado para busqueda de libros para el Autor=${params.autor}"
        //def libros= libroService.buscarLibrosInseguro(params.autor)
